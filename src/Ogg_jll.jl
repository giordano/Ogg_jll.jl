...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Ogg_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e7412a2a-1a6e-54c0-be00-318e2571c051"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Ogg", artifacts_toml) for e in artifacts["Ogg"]]
...
if best_platform === nothing
    @debug("Unable to load Ogg; unsupported platform $(triplet(platform_key_abi()))")
else
